 ...
 *
 * $Id: OpenGL_GLNativeIntArray.c,v 1.3 2001/07/06 23:40:05 razeh Exp $
 *
...
{
	(*env)->ReleaseIntArrayElements(env, jbuffer, (jint*)buffer, 0);
}
...
JNIEXPORT void JNICALL Java_OpenGL_GLNativeIntArray_copyBuffer
  (JNIEnv *env, jobject feedbackBuffer, jintArray jbuffer, jint buffer)
{
	(*env)->ReleaseIntArrayElements(env, jbuffer, (jint*)buffer, JNI_COMMIT);
}
