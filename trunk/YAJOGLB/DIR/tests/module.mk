...
JAVA_SRC += tests/VertexPointer.java tests/Stretch.java				\
	    tests/NurbsSurface.java						\
            tests/GeometryViewer.java tests/GeometryObject.java			\
	    tests/PlainCube.java						\
	    tests/Vec.java tests/OpenGLCanvasTest.java tests/Concurrence.java	\
	    tests/ExitableFrame.java tests/MatrixModifiers.java			\
	    tests/Sphere.java							\
	    tests/Feedback.java tests/Axis.java					\
            tests/TexturedCube.java tests/Simplest.java				\
	    tests/TessVertex.java tests/QuadricError.java			\
	    tests/NurbsCallback.java tests/Select.java				\
